<?php  function SEND_EMAIL_INVITEZ_VOS_CONTACTS($connection_database2, $id_affiliate, $email_a_inviter)
{      include('config.php');  

	 // REQUETTE DE REMPLISSAGE DU MAIL 

		 $reponse2 = mysql_fetch_array(mysql_query(" SELECT email, first_name, last_name, zip_code, city, phone_number FROM affiliate_details where id_affiliate =".$id_affiliate."  limit 0,1   ")) or die("Requete pas comprise - #32! ");
	     $a_first_name   = $reponse2['first_name'];
		 $a_last_name    = $reponse2['last_name'];
		 $a_city         = $reponse2['city'];
		 $zip_code       = $reponse2['zip_code'];
		 $mail_cc        = $reponse2['email'];
	     $phone_number   = $reponse2['phone_number'];
		 
		 $mail           = $email_a_inviter;
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Comme discuté ensemble, j'ai rejoint le réseau social d'apporteur d'affaires NosRezo. Depuis que je suis inscrit sur ce site, il est devenu simple pour mes contacts et moi de faire appel à des professionnels qualifiés et évalués par les membres NosRezo !<!--[if !mso]><!-->
									<br/>
									<br/>
									<div> Pour découvrir le concept NosRezo, cliquez simplement sur la vidéo ci-dessous : </span><!--<![endif]-->
								    <br/>
								</td>
							</tr>
							<tr>
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 26px; color: rgb(50, 58, 69); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 32px; vertical-align: top; font-weight: 100;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_novalight', Helvetica;'><!--<![endif]-->Êtes-vous prêt ?!<!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
										<tr>
											<td width='100%' height='25'></td>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												...
												Inscrivez-vous afin de profiter gratuitement des services NosRezo, et rejoignez-nous sur la page <a href='http://www.facebook.com/pages/Nosrezo/331807033627841'>Facebook</a>  <br/>     
												Si vous avez des questions, appelez moi au <b> $phone_number  </b>. <br />
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> $a_first_name $a_last_name <!--[if !mso]><!--></span><!--<![endif]--><br/>
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Identifiant : $id_affiliate <!--[if !mso]><!--></span><!--<![endif]-->
...
//========== Définition du sujet.
$sujet = "$a_first_name $a_last_name vous invite à rejoindre NosRezo ! ";
//========= 
  
//========== Création du header de l'e-mail.
$header = "From: \"NosRezo.com\"<contact@nosrezo.com>".$passage_ligne;
//$header.= "Cc: contact@nosrezo.com, ".$mail_cc.$passage_ligne;
