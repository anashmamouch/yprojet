<?php  function SEND_PAIEMENT_EMAIL($connection_database2, $id_affiliate, $id_recommandation, $aX_amount)
{      include('scripts/config.php');  
	 ...
	 $result4 = mysql_query(" SELECT aX_id_affiliate, aX_level, aX_amount_ht, first_name FROM recommandation_comptable rc, affiliate_details ad  WHERE  rc.id_recommandation = ".$id_recommandation ." and rc.aX_id_affiliate = ad.id_affiliate  order by aX_level    ")  or die(" Requete coordonnees : 36TXPSSA pas comprise. ");			
     $aX_amount_ht_0 = 0.00;
	 $aX_amount_ht_1 = 0.00;
	 $aX_amount_ht_2 = 0.00;
	 $aX_amount_ht_3 = 0.00;
	 ...
	 $first_name_6 = "NosRezo";	 
 	 ...
 	 while ($reponse4 = mysql_fetch_array($result4))
         {  
			 ...
			 IF ( trim($aX_first_name) == "IAD France" ) { $aX_amount_ht_0 = 0;  $first_name_0 = "NosRezo";	    }
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>La vente de la recommandation <b>R$id_recommandation </b> est réalisée ! <br /> 
									<br />
									VOTRE COMPTE EST CRÉDITÉ DE <b> $aX_amount €  </b>	<br/>
									<br/>
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Une fois que $first_name_0 aura noté la prestation du partenaire, vous pourrez encaisser vos commissions en quelques clics.<!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
...
//========== Définition du sujet.
$sujet = " Votre commission NosRezo ! ";
//========= 
