<?php  function SEND_EMAIL_COMMUNICATION_AFFILIATE_PART($connection_database2, $id_recommandation, $serveur, $statut)
{      
	 ...
	 IF ($statut == 1)
	     {
	      $texte_affiliate = "Nous avons bien reçu votre recommandation. Pour l'instant nous n'avons pas de partenaire avec la <b>bonne compétence</b> sur ce secteur. Notre équipe recherche activement un bon professionnel pour votre demande.";
		 }
	 ELSE
	     {
	      $texte_affiliate = "Aucun des partenaires que nous avons recontré n'a répondu à nos critères de <b>qualité</b>. Nous sommes dans l'obligation de clôturer ce dossier. Merci de votre compréhension.";
	     }
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'> $texte_affiliate
									<br/>
									<br/>
                                         <u>Secteur</u> :   <b> $r_sub_category  </b> <br />
                                         <u>Ville</u> :  <b>  $r_zip_code  $r_city </b> <br />
                                         <u>Recommandation</u> :  <b>  R$id_recommandation  </b> <br />
									</span><!--<![endif]-->
								</td>
							</tr>
...
//========== Définition du sujet.
$sujet = "Recherche de partenaire sur le secteur ! ";
//========= 
