<?php  /// PLANNIFICATEUR DE TACHE N°1
	   ...
	   /// 55 23 * * * /usr/bin/php /kunden/homepages/0/d492946058/htdocs/scripts/cron/5_cron_nuit_IAD.php
...
///////// 1. LOAD DU FICHIER IAD FRANCE DES CONSEILLERS	   	
		 ...
		 List($raport_load_data, $etat_chargement, $nb_ligne) = LOAD_DATA_IAD_FULL($NosRezo_racine, $source_pays_partenaire); 
         $log_rapport   = $log_rapport." ".$raport_load_data;	

		 //mail('benjamin.allais@gmail.com','LANCEMENT DU SCRIT 1', 'LOAD DU FICHIER IAD FRANCE DES CONSEILLERS	' ); 
		 
		 $raport_load_data = TRAITEMENT_DATA_IAD_FULL($nb_ligne, "", $serveur, "CRON", $source_pays_partenaire);
		 $raport_load_data = str_replace("\"", "", $raport_load_data);		 
         $log_rapport      = $log_rapport." ".$raport_load_data.$retour1;			
		 
		 //mail('benjamin.allais@gmail.com','LANCEMENT DU SCRIT 2', 'TRAITEMENT_DATA_IAD_FULL' ); 
		 
		 $raport_load_data = ATTRIBUTION_DES_BONS_PARRAINS_IAD($NosRezo_racine, $source_pays_partenaire);
		 $raport_load_data = str_replace("\"", "", $raport_load_data);	
         $log_rapport      = $log_rapport." ".$raport_load_data.$retour1;

		 //mail('benjamin.allais@gmail.com','LANCEMENT DU SCRIT 3', 'ATTRIBUTION_DES_BONS_PARRAINS_IAD' ); 	
		 
		 $raport_load_data = DESACTIVATION_PARTENAIRES_ANCIEN_IAD($NosRezo_racine, $source_pays_partenaire);
		 $raport_load_data = str_replace("\"", "", $raport_load_data);			 
         $log_rapport      = $log_rapport." ".$raport_load_data.$retour1;			 
	 
		 //mail('benjamin.allais@gmail.com','LANCEMENT DU SCRIT 4', 'DESACTIVATION_PARTENAIRES_ANCIEN_IAD' ); 		 
...
///////// 5. FIN DU SCRIPT 	  
		 ...
		 //mail('benjamin.allais@gmail.com','LANCEMENT DU SCRIT 5', 'VA_BIENTOT_QUITTER_IAD '.$log_rapport ); 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// mail('benjamin.allais@gmail.com','LANCEMENT DU SCRIT 6', $message_html ,$header ); 
