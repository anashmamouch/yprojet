...
header("Access-Control-Allow-Headers: Origin, X-Requested-With, Content-Type, Accept");
     ...
     mysql_query('SET NAMES utf8');	
                         ...
                         $sql    = " SELECT s_category, s_sub_category, id_services, type FROM services WHERE is_activated = 1 
						             ORDER BY master_order_affichage, order_affichage ";
						
						IF ( $id_partenaire_is_iad  == 1)
						 {
						  $sql    = " SELECT s_category, s_sub_category, id_services, type  FROM services WHERE is_activated = 1 and id_services <> 4
						              ORDER BY master_order_affichage, order_affichage ";	 
						 }	 
