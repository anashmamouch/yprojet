<?php  function SEND_EMAIL_COMPTABLE1($connection_database2, $id_affiliate, $id_action, $id_cles_unique)
{      include('scripts/config.php');  

	 // REQUETTE DE REMPLISSAGE DU MAIL 
     mysql_query('SET NAMES utf8');
     $result                = mysql_fetch_array(mysql_query(" SELECT first_name, last_name, zip_code, email, city, id_affiliate, address, birth_date, birth_place, nationality, id_securite_sociale  FROM affiliate_details where id_affiliate =".$id_affiliate."   ")) or die("Requete pas comprise - #31! ");
	 $mail                  = $result['email'];
	 $mail                  = "cy-florette@soregor.fr";
	 ...
	 $sql = " SELECT id_comptable, id_recommandation, aX_id_affiliate, aX_amount_ht, aX_payed, aX_ref FROM recommandation_comptable where aX_id_affiliate=".$id_affiliate." AND aX_payed = 5  and aX_ref = \"".$id_cles_unique."\"    ";
	 $result2 = mysql_query($sql) or die("Requete pas comprise : comptable_paiement_mail.php ");				
   	 WHILE ($reponse = mysql_fetch_array($result2))
						...
						$somme_a_payer_brut =  $somme_a_payer_brut - 21;
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 44px; line-height: 48px; font-weight: 100;'class='textCenter' id='box' >
									<span  cu-identify='element_07997812125831842'><!--[if !mso]><!--><span style='font-family: 'proxima_novalight', Helvetica;'><!--<![endif]-->Cynthia FLORETTE, <!--[if !mso]><!--></span><!--<![endif]--></span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Cher comptable, nous venons vers vous afin de connaître le montant du paiement d'un affilié NosRezo ! <br /> 
									<br />
									Merci de mettre à jour ces informations dans votre intranet NosRezo dédié : <br/>
									<u>Login</u> : <b> 9  </b> <br />
									<u>Password</u> : <b> nosrezocompta9 </b> <br />
									<br/>
									
									<br/>
									Informations de paiement :	<br/>
                                         <u>Affilié NosRezo </u> : <b> A$id_affiliate  </b> <br />
                                         <u>Nom & Prénom </u> : <b> $last_name  $first_name  </b> <br />									 
                                         <u>Adresse</u> : <b> $address  </b> <br />
                                         <u>Ville</u> : <b> $zip_code  $city </b> <br />
										 
                                         <u>Date naissance</u> : <b> $birth_date  </b> <br />
                                         <u>Lieu naissance</u> : <b> $birth_place  </b> <br />
                                         <u>Nationalité</u> : <b> $nationality  </b> <br />
                                         <u>Numéro Sécurité Sociale</u> : <b> $id_securite_sociale  </b> <br /><br />
										 
                                         <u>Mode de paiement</u> : <b> Virement Bancaire</b> <br />
                                         <u>Référence sécurité mail </u> : <b> $id_cles_unique  </b> <br />	
                                         <u>Statut de l'affilié</u> : <b> VDI </b> <br />	
                                         <u>Commission brute HT</u> : <b> $somme_a_payer_brut € </b> <br />
                                         <u>Référence comptable </u> : <b> $ref2  </b> <br />	
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Merci de nous fournir le montant de virement ainsi que la facture VDI de cet affilié. De plus afin de vous faciliter le traitement, nous vous proposons un accès personnalisé à notre intranet.<!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
...
//========== Définition du sujet.
$sujet = " Comptable - Paiement Affilié NosRezo : ".$id_cles_unique." !";
//========= 
  
//========== Création du header de l'e-mail.
$header = "From: \"NosRezo.com\"<contact@nosrezo.com>".$passage_ligne;
//$header.= "Cc:".$mail_cc.", contact@nosrezo.com ".$passage_ligne;
$header.= "Cc: contact@nosrezo.com, em-bahirenne@soregor.fr  ".$passage_ligne;
