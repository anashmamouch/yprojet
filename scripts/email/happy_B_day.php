<?php  function SEND_HAPPY_B_DAY($connection_database2, $id_affiliate, $serveur)
{       

	 // REQUETTE DE REMPLISSAGE DU MAIL 
     mysql_query('SET NAMES utf8');
     $result        = mysql_fetch_array(mysql_query(" SELECT af.first_name, af.last_name, af.zip_code, af.email, af.city, af.id_affiliate, aa.password FROM affiliate_details af, affiliate aa WHERE af.id_affiliate=aa.id_affiliate AND af.id_affiliate =".$id_affiliate."   ")) or die("Requete pas comprise - #AZSLP31! ");
	 $mail          = $result['email'];
	 ...
	 $mail_parrain  = mail_parrain_affilie($id_affiliate);
	 
	 $rapport_activite  = "&nbsp &nbsp &nbsp &nbsp >> Mail A".$id_affiliate." - ".$first_name." ".$last_name."     <br/>";
     $duree_promo_jours = 10;
	 $amount_promo_brut = 100; 
	 $level_concerned   = 0;
	 insert_into_promotion_suivi($id_affiliate, "ANNIVERSAIRE", 1, $level_concerned, $amount_promo_brut, $duree_promo_jours, "happy_B_day.php", 1); 
									...
									<table width='150' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullCenter'>
										<tr>
											<td height='60' valign='middle' width='100%' style='text-align: left;' class='fullCenter'>
												<a href='http://www.nosrezo.com/login.php' ><img width='150' src='http://www.nosrezo.com/assets/img/logo_nosrezo.png' alt='' border='0'  cu-identify='element_023090786347165704'></a>
											</td>
										</tr>
									</table>
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									...
									Cette journée est à <b>VOUS</b> : JOYEUX ANNIVERSAIRE !<br />
                                    <br />
									<i>en cadeau   </i><br />														
									</span><!--<![endif]-->
								</td>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 24px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>
									<b>NosRezo</b> vous offre <b>$amount_promo_brut €</b>* <br />  									
									</span><!--<![endif]-->
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									...
									<br/>
									<br/>
                                    <b><i>Je ne connais personne à qui rendre service ?</i></b><br/>
									<br/>																											
									</span><!--<![endif]-->
								</td>
							</tr>
							<tr>
								<td width='100%' class='fullCenter' style='text-align: center;'><a href='#' style='text-decoration: none;' ><img src='http://www.nosrezo.com/fichiers/INFO_1.png' width='600' height='auto' style='width: 600px; height: auto; border-radius: 5px;' alt='' border='0'  class='hover'></a>
								</td>
							</tr>							
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									...
									<br/>
									<br/>
                                    <b><i>Comment je gagne de l'argent ? </i></b><br/>
									<br/>																		
									</span><!--<![endif]-->
								</td>
							</tr>
							<tr>
								<td width='100%' class='fullCenter' style='text-align: center;'><a href='#' style='text-decoration: none;' ><img src='http://www.nosrezo.com/fichiers/INFO_2.png' width='600' height='auto' style='width: 600px; height: auto; border-radius: 5px;' alt='' border='0'  class='hover'></a>
								</td>
							</tr>	
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='center' class='full'>
							...
							<tr>
								<td height='auto' width='600' valign='bottom' style='line-height: 1px; text-align: center;' >
									<a href='https://www.youtube.com/watch?v=fYGW7peAoWA&feature=youtu.be' style='text-decoration: none; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 20px;'><img width='600' height='auto' src='http://www.nosrezo.com/assets/img/email/video_laura.jpg' alt='' border='0' style='display: block; font-size: 20px; height: auto;' id='box'  cu-identify='element_08642308723647147'></a>							
								</td>
							</tr>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												...
												*Vous avez 10 jours pour faire une recommandation qui aura 6 mois pour aboutir.
												Votre commission NosRezo doit être de 200 € minimum et les 100 € viendront s'ajouter à votre commission. <br/> 
												<br/>
												<!--[if !mso]><!--></span><!--<![endif]--><br/>
											</td>
										</tr>										
										<tr>
											<td width='100%' style='font-size: 17px; color: rgb(141, 148, 153); text-align: middle; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]-->
												Il vous reste 9 jours, 23 heures, 59 minutes. 
												<!--[if !mso]><!--></span><!--<![endif]--><br/>
											</td>
										</tr>											
...
//========== Définition du sujet.
$sujet = "Aujourd'hui c'est... votre anniversaire ! ";
//========= 
  
//========== Création du header de l'e-mail.
$header = "From: \"NosRezo.com\"<contact@nosrezo.com>".$passage_ligne;
$header.= "Cc:".$mail_parrain."  ".$passage_ligne;
