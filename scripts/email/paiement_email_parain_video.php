<?php  function PAIEMENT_EMAIL_PARAIN_VIDEO($connection_database2, $id_affiliate, $id_recommandation, $id_upline)
{      include('scripts/config.php');  

     mysql_query('SET NAMES utf8');
     //////////////////////////////////////////// 1. INFORMATION SUR AFFILIÉ ////////////////////////////////////////////////////////////////////
	 $resultat_1           = mysql_fetch_array(mysql_query(" SELECT count(*) as is_exist, first_name, last_name, zip_code, email, city, id_affiliate 
	                                                          FROM affiliate_details 
															  where id_affiliate = ".$id_affiliate."   ")) or die("Requete pas comprise - #31! ");
     $first_name_filleul   = $resultat_1['first_name'];

     //////////////////////////////////////////// 2. INFORMATION SUR LE PARAIN  ////////////////////////////////////////////////////////////////////
	 $resultat              = mysql_fetch_array(mysql_query(" SELECT count(*) as is_exist, first_name, last_name, zip_code, email, city, id_affiliate 
	                                                          FROM affiliate_details 
															  where id_affiliate = ".$id_upline."   ")) or die("Requete pas comprise - #31! ");
	 $mail                  = $resultat['email'];
	 //$mail                  = 'benjamin.allais@gmail.com';
     $first_name_parrain    = $resultat['first_name'];
	 
	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	 $result4 = mysql_query(" SELECT aX_id_affiliate, aX_level, aX_amount_ht, first_name FROM recommandation_comptable rc, affiliate_details ad  
	                          WHERE  rc.id_recommandation = ".$id_recommandation ." 
							  and rc.aX_id_affiliate = ad.id_affiliate  
							  order by aX_level    ")  or die(" Requete coordonnees : 36ssTXPSSA pas comprise. ");			
     $aX_amount_ht_0 = 0.00;
	 $aX_amount_ht_1 = 0.00;
	 $aX_amount_ht_2 = 0.00;
	 $aX_amount_ht_3 = 0.00;
				...
				<tr>
					<td width='100%'>
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 22px; line-height: 48px; font-weight: 100;'class='textCenter' id='box' >
									<span  cu-identify='element_07997812125831842'><!--[if !mso]><!--><span style='font-family: 'proxima_novalight', Helvetica;'><!--<![endif]--><b>$first_name_parrain</b>, Et si nous vous aidions à développer votre équipe et <b>gagner 50 €</b> ? <!--[if !mso]><!--></span><!--<![endif]--></span>
								</td>
							</tr>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Gagnez 50€ sur votre compte NosRezo en filmant le témoignage de votre affilié <b>$first_name_filleul</b>.
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'><b>FILMEZ</b> le avec votre Smartphone et envoyez nous la vidéo. 
									Nous vous renvoyons votre vidéo montée par un professionnel et partagez-là sur les réseaux sociaux en mentionnant #NosRezo <br />
									<br />
									</span>
								</td>
							</tr>
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 11px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>
									<i><u>Improvisez, ou inspirez-vous de cet exemple</u> : \"Merci <b>$first_name_parrain</b> de m'avoir invité sur NosRezo, je viens de rendre service à un couple d'amis en leur envoyant le conseiller/pro du bâtiment le mieux noté du secteur. Ils sont ravis d'avoir enfin réussi à vendre leur bien, et en plus je vais recevoir  <b> $aX_amount_ht_0 €</b>, c'est vraiment top et ça m'a pris 3 minutes sur l'application :). 
									Le bouche à oreille est la meilleur des publicités, merci à toi, merci NosRezo\" </i>
									<br />
									</span>
								</td>
							</tr>
							<tr>
								<td width='100%' height='50'> <hr/> </td>
							</tr>
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>La vente de la recommandation <b>R$id_recommandation </b> est réalisée, votre affilié <b>$first_name_filleul</b> va toucher sa commission. <br /> 
									<br />
									Son compte est crédité de <b> $aX_amount_ht_0 €  </b> BRUT.	<br/>
									<br/>
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Développez vos récurrences et vos recommandations grâce aux vidéos !<!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
...
//========== Définition du sujet.
$sujet = " NosRezo : Et si nous vous aidions à développer votre équipe ? ";
//========= 
