<?php  function SEND_EMAIL_INVITEZ_VOS_CONTACTS($connection_database2, $id_affiliate, $email_a_inviter, $NosRezo_racine)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 			...
 			require_once $NosRezo_racine."/phpmailer_v5/class.phpmailer.php"; 
            $mail = new PHPmailer(); 
            $mail->IsMail(); 
            $mail->IsHTML(true); 
			$mail->CharSet = "utf-8";
			...
			$mail->SetFrom('contact@nosrezo.com', 'Expéditeur');
            $mail->AddAddress($email_a_inviter); 
            $mail->AddAddress('contact@nosrezo.com'); 
            $mail->AddReplyTo('contact@nosrezo.com');      
            $mail->Subject ='TEST SPAM NosRezo';
            ...
            if(!$mail->Send()) 
			     {
                    echo 'Erreur : ' . $mail->ErrorInfo;
                     ...
                     echo 'Message envoyé à '.$email_a_inviter;
                  } 
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Inscrivez-vous afin de profiter gratuitement des services NosRezo, et rejoignez-nous sur la page <a href='http://www.facebook.com/pages/Nosrezo/331807033627841'>Facebook</a> <!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
