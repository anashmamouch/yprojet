<?php  function SEND_EMAIL_INSCRIPTION_NOUVEAU_AFFILIE_PARTENAIRE_FERMETURE($connection_database2, $id_affiliate, $id_partner, $p_sub_category, $NosRezo_racine, $p_contrat_recu, $p_kbis_recu, $p_assurance_recu)
{    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ///    RELANCE DES PARTENAIRES SI NOUS N'AVONS PAS RECU LES JUSFITICATIFS DES PARTENAIRES
	 ///    1. AUTOMATIQUE 1 FOIS PAR SEMAINE APRÉS INSCRIPTION	 
   
	 ////////////////////// REQUETE DE REMPLISSAGE DU MAIL  ////////////////////////////////////////////////////////// 
	 require($NosRezo_racine.'/scripts/config.php'); 
     mysql_query('SET NAMES utf8');

     List($id_affiliate_1, $id_partenaire, $first_name_p, $last_name_p, $email_p, $phone_number_p, $address_p, $zip_code_p, $city_p, $firt_last_id , $is_activated, $last_connection_date, $password ) = return_info_affiliate($id_affiliate);
	 $mail          = $email_p;
	 //$mail          = "contact@nosrezo.com";
     $first_name    = ucwords(strtolower($first_name_p));
	 $last_name     = $last_name_p;
	 $zip_code      = $zip_code_p;
	 $city          = $city_p;
     $mdp           = $password;
	 
	 list ($id_parrain, $id_partenaire, $first_name_parrain, $last_name_parrain, $email_p, $phone_number_p, $address_p, $zip_code_p, $city_p, $firt_last_id , $id_parrain_parrain, $is_activated, $last_connection_date, $password ) = return_info_parrain($id_affiliate);
	 $parrain       = $firt_last_id;	 
	 $mail_cc       = $email_p; 
	 	 
	 IF ( $p_contrat_recu == 0)    { $p_contrat_recu = "<font color=#fa38a3> Non reçu !</font>"; }
	 ELSE                          { $p_contrat_recu = "Reçu"; }
		 
	 IF ( $p_kbis_recu == 0)       { $p_kbis_recu = "<font color=#fa38a3> Non reçu !</font>"; }
	 ELSE                          { $p_kbis_recu = "Reçu"; }	 

	 IF ( $p_assurance_recu == 0)  { $p_assurance_recu = "<font color=#fa38a3> Non reçu !</font>"; }
	 ELSE                          { $p_assurance_recu = "Reçu"; }
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 44px; line-height: 48px; font-weight: 100;'class='textCenter' id='box' >
									<span  cu-identify='element_07997812125831842'><!--[if !mso]><!--><span style='font-family: 'proxima_novalight', Helvetica;'><!--<![endif]-->$first_name $last_name, <!--[if !mso]><!--></span><!--<![endif]--></span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>
									     Vous avez été recommandé pour vos performances par <b>$first_name_parrain $last_name_parrain,</b> un membre <b>NosRezo</b> : <br/>
										     <u>Votre secteur</u> : <b>  $zip_code $city </b> <br /> 
                                             <u>Votre domaine</u> : <b>  $p_sub_category </b> <br />
									     <br/>										   
										 Malgrès nos relances, nous n'avons toujours pas reçu les documents suivants :<br/>
                                             <u>Votre contrat NosRezo</u> : <b>  $p_contrat_recu </b> <br /> 
                                             <u>Votre extrait Kbis</u> : <b>  $p_kbis_recu </b> <br />
                                             <u>Votre Assurance</u> : <b>  $p_assurance_recu </b> <br />									
									<br/>
									Nous recommandons des partenaires <b>CERTIFIÉS </b> à nos membres, car la <b>CONFIANCE</b> est une de nos valeurs ! <br/>
									Vous êtes donc désactivé en tant que partenaire NosRezo jusqu'à validation de vos garanties.
									<br/>
									<br/>
									<br/>

									Pour redécourvir le concept <b>NosRezo</b>, cliquez simplement sur la vidéo ci-dessous : 
									<br/>
									<br/>
									</span><!--<![endif]-->
								</td>
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Scannez vos documents et envoyez les à contact@nosrezo.com ! <!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]-->Rejoignez-nous sur notre page <a href='http://www.facebook.com/pages/Nosrezo/331807033627841'>Facebook</a> et rapprochez-vous de $first_name_parrain $last_name_parrain pour quelques bons conseils. <!--[if !mso]><!--></span><!--<![endif]--><br/>
											</td>
										</tr>
...
//========== Définition du sujet.
$sujet = " Partenaire NosRezo désactivé ! ";
//========= 
