<?php  function SEND_EMAIL_INSCRIPTION_NOUVEAU_AFFILIE_PARTENAIRE($connection_database2, $id_affiliate, $id_partner, $p_sub_category, $NosRezo_racine, $p_contrat_recu, $p_kbis_recu, $p_assurance_recu)
{    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>
									     ...
									     <br/>										   
										 Pour pouvoir vous envoyer des <b>recommandations d'affaires</b> nous sommes dans l'attente des documents :<br/>
...
//========== Définition du sujet.
$sujet = " Partenaire NosRezo : En attente de validation ! ";
//========= 
