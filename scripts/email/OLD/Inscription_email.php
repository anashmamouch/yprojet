<?php  function send_email_inscription_nouveau($id_affiliate, $serveur)
{      
	 ...
	 $parrain       = nom_prenom_id_parrain_affilie(return_id_parrain($id_affiliate));	 
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Vous venez de rejoindre le 1er réseau d'apporteur d'affaires. Vous pouvez dès à présent faire appel à des professionnels qualifiés et évalués par les membres <b>NosRezo </b>!
									<br/>
									<br/>
                                         <u>Membre</u> :   <b> $last_name  $first_name  </b> <br />
                                         <u>Votre ville</u> :  <b>  $zip_code $city </b> <br />
                                         <u>Parrain</u> :  <b>  $parrain </b> <br />
                                         <u>Votre identifiant</u> : <b>  <font color=#2d5f8b> $id_affiliate </font></b> <br />
                                         <u>Votre mot de passe</u> : <b>  <font color=#2d5f8b> $mdp </font></b> <br /> 
									<br/>
									Pour découvrir <b>NosRezo</b>, cliquez sur la vidéo : 
									<br/>
									<br/>
									</span><!--<![endif]-->
								</td>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
                                    ...
                                    <br />
								    <br />
									<i>Connectez-vous au webinar tous les lundis :</i> <br/>
									<u>Présentation de 21h à 21h30 en ligne</u> : <b><a href='https://attendee.gotowebinar.com/rt/7446515438792588289'>Lien webinar</a></b> <br/>
									<br/>
									</span><!--<![endif]-->
								</td>
							</tr>
