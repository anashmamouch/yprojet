<?php  function EMAIL_PARTENAIRE_HORS_SUJET_SECTEUR($connection_database2, $id_privileged_partner,  $serveur, $connection_database2)
{      
	 // REQUETTE DE REMPLISSAGE DU MAIL 
     mysql_query('SET NAMES utf8');
	 List ($id_affiliate, $id_partenaire, $first_name_a, $last_name_a, $email_a, $phone_number_a, $address_a, $zip_code_a, $city_a, $firt_last_id , $is_activated, $last_connection_date, $password, $p_sub_category, $p_company, $p_contact_mail,  $id_services, $recommanded_by, $p_zip_code, $p_city, $id_parrain  ) = RETURN_INFO_AFFILIATE_FROM_ID_PARTENAIRE($connection_database2, $id_privileged_partner);	 
     List ($id_parrain, $id_partenaire, $first_name_p, $last_name_p, $email_p, $phone_number_p, $address_p, $zip_code_p, $city_p, $firt_last_id , $id_parrain_parrain, $is_activated, $last_connection_date, $mdp ) = RETURN_INFO_PARRAIN($id_affiliate);	
	 
	 $mail         = $email_a;
	 $mdp          = $password;
	 
	 //$mail    = "benjamin.allais@gmail.com";
	 //$email_p = "benjamin.allais@gmail.com";
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 44px; line-height: 48px; font-weight: 100;'class='textCenter' id='box' >
									<span  cu-identify='element_07997812125831842'><!--[if !mso]><!--><span style='font-family: 'proxima_novalight', Helvetica;'><!--<![endif]-->$first_name_a, <!--[if !mso]><!--></span><!--<![endif]--></span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									...
									D'après vos compétences, vous avez été recommandé comme partenaire <b>NosRezo</b>. <br/>Cependant ce service n'est pas encore activé chez  <b>NosRezo</b>. <br/>
									<br/>
									En attendant, n'hésitez pas à utiliser nos services :				
									<br/>
                                         <u>Votre Login</u> :   <b> $id_affiliate  </b> <br />
                                         <u>Votre Mot de passe</u> :  <b>  $mdp </b> <br />
										 <br />
										 <br />
										 Pour rappel nos activités sont : <br />
										  - Les Travaux,  <br />
										  - La Vente Immobilière, <br />
										  - Le Financement de projets Immobiliers <br />
									</span><!--<![endif]-->
								</td>
							</tr>
...
//========== Définition du sujet.
$sujet = "NosRezo ne propose pas encore ce service  ! ";
//========= 
  
//========== Création du header de l'e-mail.
$header = "From: \"NosRezo.com\"<contact@nosrezo.com>".$passage_ligne;
$header.= "Cc: contact@nosrezo.com, ".$email_p." ".$passage_ligne;
