<?php  function SEND_PAIEMENT_EMAIL_FINAL($connection_database, $id_affiliate, $id_cles_unique, $aX_amount)
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Nous avons le plaisir de vous informer qu'un virement a été réalisé sur votre compte bancaire :<br /> 
									<br />
									<b> Vous avez perçu $aX_amount € </b> !	<br/>
									<br/>
                                    Merci de la confiance que vous nous portez et n'oubliez pas de nous recommander auprès de vos contacts pour leur faire profiter des services <b>NosRezo</b>.  
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Savez-vous que vous avez 139 occasions par an de faire appel à <b>NosRezo </b>: <a href='http://www.nosrezo.com/fichiers/INFO_1.PNG' > En savoir plus ! </a>     <!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
...
//========== Définition du sujet.
$sujet = " Virement NosRezo sur votre compte bancaire ! ";
//========= 
