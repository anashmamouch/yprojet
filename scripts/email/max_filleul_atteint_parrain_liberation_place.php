<?php  function SEND_EMAIL_DESINSCRIPTION_FILLEUL($connection_database2, $id_affiliate,  $serveur)
{      
     mysql_query('SET NAMES utf8');
     List ($id_affiliatee, $id_partenairee, $nom_filleul, $last_name, $email, $phone_number, $address, $zip_code, $ville_filleul, $firt_last_id , $is_activated, $last_connection_date, $mdpPP ) = return_info_affiliate($id_affiliate); 
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									...
									Une place dans votre organisation <b>NosRezo </b> vient de se libérer. Vous pouvez continuer à vous développer ! <br/>
									<br/>
									Désinscription :				
									<br/>
                                         <u>Votre contact</u> :   <b> $nom_filleul  </b> <br />
                                         <u>Ville contact</u> :  <b>  $ville_filleul </b> <br />
									</span><!--<![endif]-->
								</td>
							</tr>
...
//========== Définition du sujet.
$sujet = "Une nouvelle invitation NosRezo est disponible ! ";
//========= 
