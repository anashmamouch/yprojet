<?php  function SEND_PAIEMENT_EMAIL_LATTERAL2($connection_database, $id_affiliate_latteral, $id_recommandation, $id_upline)
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Bonjour <b>$first_name_latteral</b>, pour ton information un email que vient de recevoir ton parrain <b>$first_name_parrain</b>, simplement pour avoir recommandé le meilleur professionnel de son quartier : <br /> 
									<br />
									<br />
									</span>
								</td>
