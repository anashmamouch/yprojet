<?php  function SEND_EMAIL_INSCRIPTION_NOUVEAU_AFF_PART_OK($connection_database2, $id_partner, $serveur)
{     
	 ////////////////////// REQUETE DE REMPLISSAGE DU MAIL  //////////////////////////////////////////////////////////  
     list ($id_affiliate, $id_partenaire, $first_name_a, $last_name_a, $email_a, $phone_number_a, $address_a, $zip_code_a, $city_a, $firt_last_id , $is_activated, $last_connection_date, $password, $p_sub_category, $p_company, $p_contact_mail,  $id_services, $recommanded_by ) = RETURN_INFO_AFFILIATE_FROM_ID_PARTENAIRE($connection_database2, $id_partner);	 
	 list ($id_affiliatee, $id_partenairee, $first_name_p, $last_name_p, $email_p, $phone_number_p, $address_p, $zip_code_p, $city_p, $firt_last_id , $is_activated, $last_connection_date, $password ) = RETURN_INFO_AFFILIATE($recommanded_by);
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 44px; line-height: 48px; font-weight: 100;'class='textCenter' id='box' >
									<span  cu-identify='element_07997812125831842'><!--[if !mso]><!--><span style='font-family: 'proxima_novalight', Helvetica;'><!--<![endif]-->$first_name_p, <!--[if !mso]><!--></span><!--<![endif]--></span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Le partenaire que <b>vous</b> avez recommandé vient dêtre activé chez <b>NosRezo</b> ! Il va recevoir très prochainement sa 1ière recommandation.
									<br/>
									<br/>
                                         <u>Partenaire</u> :   <b> $last_name_a  $first_name_a  </b> <br />
                                         <u>Son secteur</u> : <b>  $zip_code_a $city_a </b> <br /> 
                                         <u>Son domaine</u> : <b>  $p_sub_category </b> <br />
									</span><!--<![endif]-->
								</td>
							</tr>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									...
									<br/>
									<br/>
                                    <b><i>N'oubliez pas de rendre service !</i></b><br/>
									<br/>																											
									</span><!--<![endif]-->
								</td>
							</tr>
...
//========== Définition du sujet.
$sujet = " Votre partenaire NosRezo est activé ! ";
//========= 
