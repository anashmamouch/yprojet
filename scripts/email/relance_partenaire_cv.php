<?php  function RELANCE_UN_PARTENAIRE_CV_A_JOUR( $connection_database2, $id_affiliate_qui_relance, $id_affiliate_cible, $serveur )
{      include('scripts/config.php');  

	 // REQUETTE DE REMPLISSAGE DU MAIL 
     mysql_query('SET NAMES utf8');
	 $id_affiliate  = $id_affiliate_cible; 
     ...
     $result2                   = mysql_fetch_array(mysql_query(" SELECT af.first_name, af.last_name, af.zip_code, af.email, af.city, af.id_affiliate, aa.password FROM affiliate_details af, affiliate aa WHERE af.id_affiliate=aa.id_affiliate AND af.id_affiliate =".$id_affiliate_qui_relance."   ")) or die("Requete pas comprise - #AZSLP31! ");
	 $mail_qui_relance          = $result2['email'];
     $first_name_qui_relance    = $result2['first_name'];
	 $last_name_qui_relance     = $result2['last_name'];
	 $zip_code_qui_relance      = $result2['zip_code'];
	 $city_qui_relance          = $result2['city'];	 
	 
 
	 //$mail_cc       = "contact@nosrezo.com"; 
						...
						<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='fullImage'>
							...
							<tr>
								<td height='auto' valign='bottom' width='100%' style='text-align: center; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; line-height: 20px; font-weight: normal;'class='textCenter' id='box2' >
									<span  cu-identify='element_04206447440665215'>Afin de vous envoyer <b><u>plus de recommandations</u></b>, nous souhaitons que nos partenaires détaillent <b>leur profil NosRezo</b>.<br /> 
									<br/>
									L'affilié $first_name_qui_relance $last_name_qui_relance de $city_qui_relance <b>visite votre profil</b> et souhaite avoir des informations sur vous !
									<br/>
									<br/>
									<br/>
                                    Mettez à jour <b>votre profil NosRezo</b> !  <br/>
									Cliquez sur Mon Compte / Mon Profil et validez : <br/>
									...
									<table width='600' border='0' cellpadding='0' cellspacing='0' align='left' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='bigImage'>
										...
										<tr>
											<td width='100%' style='font-size: 14px; color: rgb(141, 148, 153); text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 22px; vertical-align: top; font-weight: normal;'>	
												<!--[if !mso]><!--><span style='font-family: 'proxima_nova_rgregular', Helvetica;'><!--<![endif]--> Savez-vous que plus les affiliés ont confiance et plus ils vous recommandent à leur réseau ! <br/> <a href='http://www.nosrezo.com/fichiers/INFO_1.PNG' > En savoir plus ! </a>     <!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
...
//========== Définition du sujet.
$sujet = "Un affilié NosRezo souhaite en savoir plus sur VOUS ! ";
//========= 
